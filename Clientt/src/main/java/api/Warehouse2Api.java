...
public interface Warehouse2Api {
    ...
    Observable<Response<Warehouse2>> getGoodInWare(@Header("Authorization") String token, @Path("id") Integer id);

    @GET("warehouse2/getGoodByWareId/{id}")
    Observable<Response<Goods>> getGoodByWareId(@Header("Authorization") String token, @Path("id") Integer id);
    ...
    Observable<Response<Void>> removeGoodById(@Header("Authorization") String token, @Path("id") Integer id);

    @DELETE("warehouse2/removeByBatchId/{id}")
    Observable<Response<Void>> removeGoodByWare(@Header("Authorization") String token, @Path("id") Integer id);
}
